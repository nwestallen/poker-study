...
var i_34485 = (0);
while(true){
if((i_34485 < arr.length)){
(arr[i_34485] = null);

var G__34487 = (i_34485 + (1));
i_34485 = G__34487;
continue;
} else {
}
...
var i_34537 = (self__.level + (1));
while(true){
if((i_34537 <= (new_level + (1)))){
(update[i_34537] = self__.header);

var G__34538 = (i_34537 + (1));
i_34537 = G__34538;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_34548 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_34548[i]));
} else {
x__$2.forward.push((((i < links_34548.length))?(links_34548[i]):null));
}

if((i < links_34548.length)){
(links_34548[i] = x__$2);
} else {
links_34548.push(x__$2);
}
...
var i_34563 = (0);
while(true){
if((i_34563 <= self__.level)){
var links_34569 = (update[i_34563]).forward;
if((x__$1 === (((i_34563 < links_34569.length))?(links_34569[i_34563]):null))){
(links_34569[i_34563] = (x__$1.forward[i_34563]));

var G__34572 = (i_34563 + (1));
i_34563 = G__34572;
continue;
} else {
var G__34573 = (i_34563 + (1));
i_34563 = G__34573;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__34591 = nx;
var G__34592 = (level__$1 - (1));
x = G__34591;
level__$1 = G__34592;
continue;
} else {
var G__34593 = x;
var G__34594 = (level__$1 - (1));
x = G__34593;
level__$1 = G__34594;
continue;
}

...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__42159_SHARP_,p2__42158_SHARP_){
return p2__42158_SHARP_.toUpperCase();
}));
...
var G__42160 = o;
helix.impl.props.goog$module$goog$object.set(G__42160,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__42170 = cljs.core.rest(m);
var G__42171 = (function (){var entry = cljs.core.first(m);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42163_SHARP_){
if(cljs.core.map_QMARK_(p1__42163_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__42163_SHARP_);
} else {
return p1__42163_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__42173 = cljs.core.rest(m);
var G__42174 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__42177 = cljs.core.rest(m);
var G__42178 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);

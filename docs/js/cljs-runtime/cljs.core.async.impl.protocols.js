...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31916 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31916(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31919 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31919(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31922 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31922(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31930 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31930(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31935 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31935(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31937 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31937(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_31938 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_31938(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31942 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31942(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31944 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31944(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31973 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31973(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32000 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32000(b);
}
});

...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34724 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_34724(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_34729 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_34729(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_34731 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_34731(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_34738 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_34738(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34748 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_34748(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34752 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_34752(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__34703,callback){
var map__34705 = p__34703;
var map__34705__$1 = cljs.core.__destructure_map(map__34705);
var input = map__34705__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34705__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34705__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
